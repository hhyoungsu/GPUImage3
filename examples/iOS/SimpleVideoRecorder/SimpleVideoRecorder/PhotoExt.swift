//
//  PHPhotoLibraryExt.swift
//  Smoothy
//
//  Created by Hyoungsu Ham on 2018. 3. 23..
//  Copyright © 2018년 Smoothy. All rights reserved.
//
...
extension PHPhotoLibrary {
    ...
    fileprivate func saveVideo(url: URL, album: PHAssetCollection, completion:((PHAsset?)->())? = nil) {
